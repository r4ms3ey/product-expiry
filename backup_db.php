...
<head>
  ...
  <title>Backup Database - Admin Dashboard</title>
              ...
              <form role="form" action="backup.php" method="POST">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" name="txtservername" class="form-control" size="77" value="localhost" readonly>
                  </div>
				   <div class="form-group">
                    <label for="exampleInputEmail1">Username </label>
                    <input type="text" name="txtusername" class="form-control" size="77" value="root" readonly>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1"> Password</label>
                    <input type="password" name="txtpassword" class="form-control" size="77" value="" readonly>
                  </div>
                  
                  <div class="form-group">
                    <label for="exampleInputPassword1"> Database Name</label>
                    <input type="text" name="txtdbname" class="form-control" size="77" value="product_expiry_goodness" readonly>
                  </div>
                ...
                <div class="card-footer">
                  <button type="submit" name="btnbackup" class="btn btn-primary">Backup</button>
                </div>
              </form>
            </div>
