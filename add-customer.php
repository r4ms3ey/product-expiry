...
if (isset($_GET['delete_email'])) {
    try {
        ...
        $stmt = $dbh->prepare("DELETE FROM customer WHERE email = :email");
        $stmt->bindParam(':email', $delete_email);
        $stmt->execute();
...
if (isset($_GET['edit_email'])) {
    ...
    $stmt = $dbh->prepare("SELECT * FROM customer WHERE email = :email");
...
if (isset($_POST["btnsave"])) {
    ...
    $status = 'active'; // fixed status as per requirement
    ...
    if (!filter_var($email_cust, FILTER_VALIDATE_EMAIL)) {
        ...
        try {
            if (isset($_POST['original_email'])) {
                // Update existing customer using email
                ...
                // Insert new customer
                $stmt = $dbh->prepare("INSERT INTO customer(fullName, email, mobile, phone2, address, address2, city, district, status) 
                                     VALUES(:fullName, :email, :mobile, :phone2, :address1, :address2, :city, :district, :status)");
                $stmt->bindParam(':fullName', $fullName);
                $_SESSION['success'] = "Customer added successfully!";
            }
            
            $stmt->bindParam(':email', $email_cust);
  ...
  <section class="content-header">
    ...
    <div class="row mb-2">
      ...
      <ol class="breadcrumb float-sm-right">
        ...
        <li class="breadcrumb-item active"><?php echo isset($edit_data) ? 'Edit Customer' : 'Add Customer'; ?></li>
            </ol>
          </div>
        </div>
      </div>
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="customerTable" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php
                    $stmt = $dbh->query("SELECT * FROM customer ORDER BY fullName");
                    while ($row = $stmt->fetch()) {
                      echo "<tr>
                              ...
                              <td>{$row['status']}</td>
                              <td>
                                <a href='add-customer.php?edit_email={$row['email']}' class='btn btn-sm btn-primary'>Edit</a>
                                <a href='add-customer.php?delete_email={$row['email']}' class='btn btn-sm btn-danger' onclick='return confirm(\"Are you sure you want to delete this customer?\");'>Delete</a>
                              </td>
                            </tr>";
                    }
                    ?>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card card-default">
              <div class="card-header">
                <h3 class="card-title"><?php echo isset($edit_data) ? 'Edit Customer' : 'Add New Customer'; ?></h3>
              </div>
              <!-- /.card-header -->
              <?php
              ...
              <form action="" method="POST">
                <?php if (isset($edit_data)): ?>
                  <input type="hidden" name="original_email" value="<?php echo $edit_data['email']; ?>">
                <?php endif; ?>
                    ...
                    <div class="col-md-3">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="fullName" id="fullName" 
                               value="<?php echo isset($edit_data) ? $edit_data['fullName'] : ''; ?>" 
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="mobile" id="mobile" 
                               value="<?php echo isset($edit_data) ? $edit_data['mobile'] : ''; ?>" 
                    ...
                    <div class="col-md-3">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="phone2" 
                               value="<?php echo isset($edit_data) ? $edit_data['phone2'] : ''; ?>" 
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="address2" id="address2" 
                               value="<?php echo isset($edit_data) ? $edit_data['address2'] : ''; ?>" 
                    ...
                    <div class="col-md-3">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="city" id="city" 
                               value="<?php echo isset($edit_data) ? $edit_data['city'] : ''; ?>" 
                               placeholder="Enter customer city" required>
                      </div>
                      <div class="form-group">
                        <label for="exampleInputEmail1">District: </label>
                        <input type="text" class="form-control" name="district" id="district" 
                               value="<?php echo isset($edit_data) ? $edit_data['district'] : ''; ?>" 
                               placeholder="Enter customer district" required>
                      </div>
                    </div>
                    <div class="col-md-3">
                      <div class="form-group">
                ...
                <div class="card-footer">
                  <input type="submit" name="btnsave" class="btn btn-primary" 
                         value="<?php echo isset($edit_data) ? 'Update Customer' : 'Save Customer'; ?>">
                  <?php if (isset($edit_data)): ?>
                    <a href="add-customer.php" class="btn btn-default">Cancel</a>
                  <?php endif; ?>
                </div>
              </form>
            </div>
