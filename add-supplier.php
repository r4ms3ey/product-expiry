...
$supplier_name = $_POST['txtsupplier_name'];
$address = $_POST['txtaddress'];

			
///check if supplier already exist
$stmt = $dbh->prepare("SELECT * FROM tblsupplier WHERE supplier_name=?");
$stmt->execute([$supplier_name]); 
$row_supplier = $stmt->fetch();

if ($row_supplier) {
$_SESSION['error'] ='Supplier Already Exist in our Database ';

} else {
 //Add course details
$sql = 'INSERT INTO tblsupplier(supplier_name,address) VALUES(:supplier_name,:address)';
      ...
      <div class="container-fluid">
        <div class="row">
            ...
            <div class="card card-primary">
              ...
              <form id="form" action="" method="post" class="">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="txtsupplier_name" id="exampleInputEmail1" size="77" value="<?php if (isset($_POST['txtsupplier_name']))?><?php echo $_POST['txtsupplier_name']; ?>" >
                  </div>


                  <div class="form-group">
                    <label for="exampleInputEmail1">Address </label>
                    <input type="text" class="form-control" name="txtaddress" id="exampleInputEmail1" size="77" value="<?php if (isset($_POST['txtaddress']))?><?php echo $_POST['txtaddress']; ?>" >
                  </div>
          ...
          <div class="col-md-8">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Supplier Record</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                  <table width="106%" align="center" class="table table-bordered table-striped" id="example1">
                    ...
                    <tr> <th width="3%"><div align="center">#</div></th>
                        <th width="13%"><div align="center">Supplier Name</div></th>
                        <th width="13%"><div align="center">Address</div></th>
...
<?php 
                  $data = $dbh->query("SELECT * FROM tblsupplier ORDER BY supplier_name DESC")->fetchAll();
                  $cnt=1;
                  foreach ($data as $row) {
                    ?>
					  ...
					  <td height="47"><div align="center"><?php echo $cnt; ?></div></td>
                        <td><div align="center"><?php echo $row['supplier_name']; ?></div></td>
                    ...
                    <div class="dropdown-menu" role="menu">
                                           ...
                                           <a class="dropdown-item" href="delete-supplier.php?id=<?php echo $row['ID'];?>" onClick="return deldata();">Delete</a>
